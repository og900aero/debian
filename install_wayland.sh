...
# Others
apt install -y apt-file testdisk duf tealdeer ripgrep git-delta freerdp3-wayland freerdp3-x11 libsecret-tools cuetools shntool flac eza psmisc gnome-keyring heif-gdk-pixbuf bc zenity
apt-file update
