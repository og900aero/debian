...
apt install -y xwayland swaylock dunst libnotify-bin acpi brightnessctl cliphist swaybg grim slurp wf-recorder wlrctl
...
# Others
apt install -y apt-file testdisk tealdeer ripgrep git-delta freerdp3-wayland freerdp3-x11 libsecret-tools cuetools shntool flac eza psmisc gnome-keyring heif-gdk-pixbuf bc zenity
apt-file update
