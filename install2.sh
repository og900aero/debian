...
apt install imagemagick imv trash-cli xclip fuse-zip zip unzip unrar curlftpfs zstd fzf mediainfo ueberzug bspwm sxhkd exa subversion i3lock xautolock dunst kitty libreoffice-gtk3 libreoffice-l10n-hu transmission-gtk gnome-calculator vifm neofetch mpv grsync htop sshfs rofi
